...
PARTIES = ['Aryabhatt_Party', 'Dhruv_Party', 'Chanakya_Party']
...
def generate_candidate_data(candidate_number, total_parties):
    ...
    if response.status_code == 200:
        ...
        return {
            ...
            'biography': 'A brief biography of the candidates',
...
if __name__ == "__main__":
    ...
    try:
        ...
        # cursor is going to allow us to connect to postgres, get queries run
        cur = conn.cursor()
